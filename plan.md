...
| 버전 | 날짜 | 작성자 | 변경 내용 |
|------|------|--------|----------|
| 1.4.0 | 2025-12-12 | @claude | GA4 통합, 태그 시스템(/tags), 뉴스레터 Buttondown 통합 |
| 1.3.0 | 2025-12-12 | @claude | MVP 폴리싱 - 브랜드, 법적 페이지, 뉴스레터 UX |
...
│                         PROJECT STATUS                                  │
├─────────────────────────────────────────────────────────────────────────┤
│  Phase: 2 - Content & SEO 🔄 IN PROGRESS                                │
│  Version: 1.4.0                                                         │
│  Branch: dev                                                            │
│  Last Build: ✅ Success (101 pages)                                     │
├─────────────────────────────────────────────────────────────────────────┤
│  Progress: ██████████████████░░ 90%                                     │
└─────────────────────────────────────────────────────────────────────────┘
```
...
- [x] Google Analytics 4 연동 ✅ v1.4.0
  - [x] `PUBLIC_GA_MEASUREMENT_ID` 환경 변수
  - [x] GA gtag 스크립트 추가 (BaseLayout.astro)
  - [ ] 이벤트 트래킹 설정
...
- [ ] OG 이미지 최적화
  - [x] 기본 OG 이미지 설정 (`/og-default.jpg`)
  - [ ] 콘텐츠별 OG 이미지 템플릿

### 2.5 태그 시스템 ✅ v1.4.0

- [x] `/tags` 태그 인덱스 페이지 (태그 클라우드)
- [x] `/tags/[tag]` 동적 태그 상세 페이지
- [x] ArticleLayout 태그 링크 연결
...
- [x] Pagefind 정적 검색 통합 (astro-pagefind)
- [x] `/buscar` 검색 페이지 (필터, 페이지네이션, 하이라이트)
- [x] SearchInput 컴포넌트 (헤더 + 모바일)
- [x] SearchFilters 컴포넌트 (카테고리 필터)

### 3.2 필터링 & 정렬

- [x] 검색 필터 (dramas, kpop, noticias, guias)
...
- [x] NewsletterForm 컴포넌트 (`src/components/newsletter/`)
- [x] Buttondown 통합 (SSG 호환)
- [x] 카드/인라인 variant 지원
- [ ] 구독 확인 페이지 (Buttondown 제공)
...
| Phase 2: Content & SEO | 70% | 🔄 진행 중 |
| Phase 3: Features | 60% | 🔄 진행 중 |
