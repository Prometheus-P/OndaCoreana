...
- [x] K-Drama 샘플 1개 (`reina-de-las-lagrimas.mdx`)
- [x] K-Pop 샘플 1개 (`aespa.mdx`)
- [x] 뉴스 샘플 1개 (`bts-regreso-2025.mdx`)
- [x] 가이드 샘플 1개 (`donde-ver-kdramas-latinoamerica.mdx`)
- [ ] 추가 샘플 콘텐츠 6개 이상
...
| Phase | 진행률 | 상태 |
|-------|--------|------|
| Phase 1: Foundation | 90% | 🔄 진행 중 |
| Phase 2: Content & SEO | 0% | ⏳ 대기 |
