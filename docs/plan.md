...
**v0.4.0-alpha.2** - Phase 4 Content API 완성

## 변경 이력 (Changelog)

| 버전 | 날짜 | 작성자 | 변경 내용 |
|------|------|--------|----------|
| 1.6.0 | 2025-11-27 | @claude | Phase 4 Content API 완성 (SupabaseContentRepository, REST API, 통합 테스트 14개) |
...
| v0.4.0-alpha.2 | Phase 4 | 2025-11-27 | Content API 완성 |
